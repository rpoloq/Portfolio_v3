!function(t, e) {
    ...
    function i(i, s) {
        function o() {
            ...
            d.fillStyle = s.dotColor,
            d.strokeStyle = s.lineColor,
        ...
        function h() {
            ...
            this.position = {
                x: Math.ceil(Math.random() * l.width),
                y: Math.ceil(Math.random() * l.height)
            },
            this.speed = {},
            s.directionX) {
            case "left":
        ...
        var l, d, f, c, x, u, m = !!e.createElement("canvas").getContext, y = [], g = 0, w = 0, v = !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i), X = !!t.DeviceOrientationEvent, Y = 0, O = 0, S = !1;
        return s = function(t) {
            t = t || {};
            for (var e = 1; e < arguments.length; e++) {
                ...
                if (i)
                    for (var a in i)
                        i.hasOwnProperty(a) && ("object" == typeof i[a] ? deepExtend(t[a], i[a]) : t[a] = i[a])
            }
            return t
        }({}, t[a].defaults, s),
        h.prototype.draw = function() {
            d.beginPath(),
            d.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY, s.particleRadius / 2, 0, 2 * Math.PI, !0),
            d.closePath(),
            d.fill(),
            d.beginPath();
            for (var t = y.length - 1; t > this.stackPos; t--) {
                ...
                Math.sqrt(i * i + a * a).toFixed(2) < s.proximity && (d.moveTo(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY),
                s.curvedLines ? d.quadraticCurveTo(Math.max(e.position.x, e.position.x), Math.min(e.position.y, e.position.y), e.position.x + e.parallaxOffsetX, e.position.y + e.parallaxOffsetY) : d.lineTo(e.position.x + e.parallaxOffsetX, e.position.y + e.parallaxOffsetY))
            }
            d.stroke(),
            d.closePath()
        }
        ...
        h.prototype.updatePosition = function() {
            if (s.parallax) {
                ...
                this.parallaxTargY = (u - c / 2) / (s.parallaxMultiplier * this.layer),
        ...
        function() {
            if (m) {
                (l = e.createElement("canvas")).className = "pg-canvas",
                l.style.display = "block",
                i.insertBefore(l, i.firstChild),
                d = l.getContext("2d"),
                o();
                for (var a = Math.round(l.width * l.height / s.density), n = 0; a > n; n++) {
                    var f = new h;
                    f.setStackPos(n),
                    y.push(f)
                }
                t.addEventListener("resize", function() {
                    !function() {
                        o();
                        for (var t = i.offsetWidth, e = i.offsetHeight, a = y.length - 1; a >= 0; a--)
                            (y[a].position.x > t || y[a].position.y > e) && y.splice(a, 1);
                        var n = Math.round(l.width * l.height / s.density);
                        if (n > y.length)
                            for (; n > y.length; ) {
                                var r = new h;
                                y.push(r)
                ...
                X && !v && t.addEventListener("deviceorientation", function() {
    ...
    n && (n.fn[a] = function(t) {
        if ("string" == typeof arguments[0]) {
            ...
            return this.each(function() {
                n.data(this, "plugin_" + a) && "function" == typeof n.data(this, "plugin_" + a)[s] && (e = n.data(this, "plugin_" + a)[s].apply(this, o))
            }),
            void 0 !== e ? e : this
        }
...
$(document).ready(function() {
    var t = $("#particle-ground");
    $("#particle-ground-2");
    t.length && t.particleground({
        dotColor: "#ffffff",
        lineColor: "#ffffff"
    })
});
